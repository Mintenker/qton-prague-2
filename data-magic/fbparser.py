...
tags = ["status_id", "status_message", "link_name", "status_type",
...
def scrapePage(page_id, access_token, since_date, until_date):
    has_next_page = True
    num_processed = 0
    ...
    while has_next_page:
        ...
        for status in statuses['data']:
            ...
            if 'reactions' in status:
                ...
                post_data = status_data + reactions_data
                post = dict()
                for i in range(0, len(tags)):
                    post[tags[i]] = post_data[i]
